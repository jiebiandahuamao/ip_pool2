...
class Crawler(object, metaclass=ProxyMetaclass):
    ...
    def crawl_mogu(self):
        url = 'http://piping.mogumiao.com/proxy/api/get_ip_bs?appKey=5438b1860735484eb69d383253e94b2e&count=10&expiryDate=0&format=1&newLine=2'
        html = get_page(url)
        if html:
            result = json.loads(html)
            proxies = result.get('msg')
    ...
    #     url = 'http://api.xdaili.cn/xdaili-api//greatRecharge/getGreatIp?spiderId=fa88b90f2a194d7cbd76b89795a2ee66&orderno=YZ201862599854UmHYJ&returnType=2&count=10'
    #     html = get_page(url)
    #     if html:
    #         urls = html.split('\n')
    #         for url in urls:
